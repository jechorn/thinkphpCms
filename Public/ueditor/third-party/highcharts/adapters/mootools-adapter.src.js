...
// JSLint options:
/*global Fx, $, $extend, $each, $merge, Events, Event, DOMEvent.class */
...
var win = window,
	...
	legacyEvent = legacy || mooVersion === '1.3', // In versions 1.1 - 1.3 the event class is named Event, in newer versions it is named DOMEvent.class.
